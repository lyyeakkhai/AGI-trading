  ...
  <div className="fixed inset-y-0 right-0 z-40 w-full max-w-xl bg-bg-900 border-l border-border-color shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-right duration-200">
    ...
    <div className="flex items-center gap-2.5">
     ...
     <div>
      <div className="flex items-center gap-2">
       <span className="text-base font-bold text-gray-100 font-sans">
        {position.symbol}
       </span>
   ...
   <div className="flex-1 overflow-y-auto p-4 space-y-4">
    ...
    <Surface variant="default" padded="md" className="space-y-3 bg-bg-950">
     <div className="flex items-center justify-between border-b border-border-color pb-2">
      ...
      <div className="text-right">
       ...
       <span className="text-base font-sans font-bold text-gray-100 block">
        ${position.positionValue.toLocaleString()}
       </span>
       <span className="text-xs font-sans text-indigo-600 dark:text-indigo-400">
    ...
    <Surface variant="default" padded="md" className="space-y-2.5">
     <span className="text-xs font-sans font-bold text-gray-200 block border-b border-border-color pb-1.5">
     ...
     <div className="grid grid-cols-2 gap-2 text-xs font-sans">
      ...
      >
       <div className="flex items-center gap-1.5">
        <LineChart size={13} className="text-indigo-600 dark:text-indigo-400" />
    ...
    <div className="p-3 rounded bg-surface-2/40 border border-border-color text-xs font-sans text-gray-400 space-y-1">
