  ...
  <Surface variant="default" padded="md" className={`space-y-3 ${className}`}>
   ...
   <div className="flex flex-wrap items-center gap-2 text-xs font-sans">
    ...
    >
     ...
     <span className="font-bold text-indigo-600 dark:text-indigo-400">{position.opportunityId}</span>
    ...
    >
     ...
     <span className="font-bold text-indigo-600 dark:text-indigo-400">{position.proposalId}</span>
     <ArrowRight size={10} className="text-gray-500" />
    </Link>
   ...
   <div className="space-y-2 text-xs">
    ...
    <div className="p-2.5 rounded bg-bg-950/70 border border-border-color space-y-1">
     <div className="flex items-center gap-1 text-xs font-sans text-gray-400 font-semibold">
    ...
    <div className="p-2.5 rounded bg-bg-950/70 border border-border-color space-y-1">
     <div className="flex items-center gap-1 text-xs font-sans text-gray-400 font-semibold">
      <ArrowRight size={12} className="text-indigo-600 dark:text-indigo-400" />
    ...
    <div className="p-2.5 rounded bg-bg-950/70 border border-loss/20 space-y-1">
     <div className="flex items-center gap-1 text-xs font-sans text-loss font-semibold">
