  ...
  <Surface variant="default" padded="md" className={`space-y-4 ${className}`}>
   ...
   <div className="flex items-center justify-between border-b border-border-color pb-2">
    <div className="flex items-center gap-2">
     <Crosshair size={14} className="text-indigo-600 dark:text-indigo-400" />
    ...
    <div className="flex items-center gap-2 text-xs font-sans">
     ...
     <span className="font-bold text-indigo-600 dark:text-indigo-400 px-1.5 py-0.5 rounded bg-cyan-500/10 border border-cyan-500/20">
      {position.riskReward}
     </span>
    </div>
   </div>
   ...
   <div className="space-y-2 font-sans text-xs">
    ...
    <div className="flex items-center justify-between p-2.5 rounded bg-bg-950 border border-profit/30 text-profit">
     ...
     <div className="text-right">
      <span className="text-xs text-gray-400 block">From Current</span>
    ...
    <div className="flex items-center justify-between p-2.5 rounded bg-surface-2/80 border border-cyan-500/40 text-gray-200 shadow-[0_0_12px_rgba(0,229,255,0.08)]">
     ...
     <div className="text-right">
      <span className="text-xs text-gray-400 block">P&L Status</span>
      <span
    ...
    <div className="flex items-center justify-between p-2.5 rounded bg-bg-950 border border-loss/30 text-loss">
     ...
     <div className="text-right">
      <span className="text-xs text-gray-400 block">Stop Buffer</span>
   ...
   <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-2 border-t border-border-color text-xs font-sans">
    <div className="p-2 rounded bg-bg-950/60 border border-border-color">
     <span className="text-xs text-gray-500 block ">Position Size</span>
    ...
    <div className="p-2 rounded bg-bg-950/60 border border-border-color">
     <span className="text-xs text-gray-500 block ">Notional Value</span>
     <span className="text-gray-200 font-bold">
    ...
    <div className="p-2 rounded bg-bg-950/60 border border-border-color">
     <span className="text-xs text-gray-500 block ">Allocated Margin</span>
